...
CREATE TABLE PROPERTY (
    ...
    ImagePathPrimary 				char(50) 					DEFAULT NULL,
    ImagePathPrimaryThumb 			char(50) 					DEFAULT NULL,
    ImagePathKitchen 				char(50) 					DEFAULT NULL,
    ImagePathKitchenThumb 			char(50) 					DEFAULT NULL,
    ImagePathMainBath 				char(50) 					DEFAULT NULL,
    ImagePathMainBathThumb 			char(50) 					DEFAULT NULL,
    ImagePath4 						char(50) 					DEFAULT NULL,
    ImagePath4Thumb 				char(50) 					DEFAULT NULL,
    ImagePath5 						char(50) 					DEFAULT NULL,
    ImagePath5Thumb 				char(50) 					DEFAULT NULL,
    ImagePath6 						char(50) 					DEFAULT NULL,
    ImagePath6Thumb 				char(50) 					DEFAULT NULL,
    ImagePath7 						char(50) 					DEFAULT NULL,
    ImagePath7Thumb 				char(50) 					DEFAULT NULL,
