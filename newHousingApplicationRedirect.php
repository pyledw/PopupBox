...
session_start();
    ...
    $stmt = $con->prepare("
            UPDATE APPLICATION SET
                ...
                SecondaryOccupantRelationship=:relationship,                                   Pet1Type=:animalType,                  Pet1Breed=:animalBreed,
                Pet1Age=:animalAge,                  Pet1Weight=:animalWeight,                            Pet2Type=:animalType2,                  Pet2Breed=:animalBreed2,
                Pet2Age=:animalAge2,                  Pet2Weight=:animalWeight2,                            Pet3Type=:animalType3,                  Pet3Breed=:animalBreed3,
                Pet3Age=:animalAge3,                  Pet3Weight=:animalWeight3,                            SecondaryOccupantLName=:lName
