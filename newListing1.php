...
<!-- Page Content -->
    ...
    <div id="mainContent">
        <form class="formStyle" width="90%" height="90%" method="post" action="newListing1Redirect.php">
                ...
                No<input type="radio" name="ice"checked='checked'  value="0" <?php if($row[IceMaker] == '0'){echo "checked='checked'";}?> /><br/>
                Dish Washer
                Yes<input type="radio" name="dishWasher"  value="1" <?php if($row[DishWasher] == '1'){echo "checked='checked'";}?> />
                No<input type="radio" name="dishWasher"checked='checked'  value="0" <?php if($row[DishWasher] == '0'){echo "checked='checked'";}?> /><br/>
                Disposal
                Yes<input type="radio" name="disposal"  value="1" <?php if($row[Disposal] == '1'){echo "checked='checked'";}?>/>
                No<input type="radio" name="disposal"checked='checked'  value="0" <?php if($row[Disposal] == '0'){echo "checked='checked'";}?> /><br/>
                Clothes Washer
                Yes<input type="radio" name="clothesWasher"  value="1" <?php if($row[ClothesWasher] == '1'){echo "checked='checked'";}?> />
                No<input type="radio" name="clothesWasher"checked='checked'  value="0" <?php if($row[ClothesWasher] == '0'){echo "checked='checked'";}?> /><br/>
                Clothes Dryer
                Yes<input type="radio" name="clothesDryer"  value="1" <?php if($row[ClothesDryer] == '1'){echo "checked='checked'";}?> />
                No<input type="radio" name="clothesDryer"checked='checked'  value="0" <?php if($row[ClothesDryer] == '0'){echo "checked='checked'";}?> /><br/>
                Microwave
                Yes<input type="radio" name="microwave"  value="1" <?php if($row[Microwave] == '1'){echo "checked='checked'";}?> />
                No<input type="radio" name="microwave"checked='checked'  value="0"  <?php if($row[Microwave] == '0'){echo "checked='checked'";}?>/><br/>
                Security System
                Yes<input type="radio" name="security"  value="1" <?php if($row[SecurityAlarm] == '1'){echo "checked='checked'";}?> />
                No<input type="radio" name="security"checked='checked'  <?php if($row[SecurityAlarm] == '0'){echo "checked='checked'";}?> value="0" /><br/>
                Deck
                Yes<input type="radio" name="deck"  value="1" <?php if($row[Deck] == '1'){echo "checked='checked'";}?>/>
                No<input type="radio" name="deck"checked='checked'  value="0" <?php if($row[Deck] == '0'){echo "checked='checked'";}?>/><br/>
                Pool
                Yes<input type="radio" name="pool"  value="1" <?php if($row[Pool] == '1'){echo "checked='checked'";}?>/>
                No<input type="radio" name="pool"checked='checked'  value="0" <?php if($row[Pool] == '0'){echo "checked='checked'";}?>/><br/>
                Fenced
                Yes<input type="radio" name="fenced"  value="1" <?php if($row[Fenced] == '1'){echo "checked='checked'";}?>/>
                No<input type="radio" name="fenced"checked='checked'  value="0" <?php if($row[Fenced] == '0'){echo "checked='checked'";}?>/><br/>
                ...
                No<input type="radio" name="ADA"checked='checked'  value="0" <?php if($row[ADACompliant] == '0'){echo "checked='checked'";}?>/><br/>
                
                Clothes Dryer Hookups?
                Yes<input type="radio" name="dryerHookup"  value="1" <?php if($row[ClothesDryerHookup] == '1'){echo "checked='checked'";}?>/>
                No<input type="radio" name="dryerHookup"checked='checked'  value="0" <?php if($row[ClothesDryerHookup] == '0'){echo "checked='checked'";}?>/><br/>
                ...
                No<input type="radio" name="washerHookup"checked='checked'  value="0" <?php if($row[ClothesWasherHookup] == '0'){echo "checked='checked'";}?>/><br/>
