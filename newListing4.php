    ...
    <div id="mainContent">
        <form class="listingForm" width="90%" height="90%" method="post" action="newListing4Redirect.php">
            <table class="tableForm">
                ...
                <tr>
                    <td>
                        Will you allow a resident(s) with a criminal history?<br/>
                        Yes<input type="radio" name="criminalHistory"  value="1" <?php if($row[AllowCriminalHistory] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="criminalHistory"  value="0" <?php if($row[AllowCriminalHistory] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
                        Will you allow only residents with a minimum salary?<br/>
                        Yes<input type="radio" name="minSalary"  value="1" <?php if($row[MinimumSalary] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="minSalary"  value="0"<?php if($row[MinimumSalary] == '0'){echo "checked='checked'";}?> />
                    </td>
                    <td>
                        Will you allow only non-smoking residents?<br/>
                        Yes<input type="radio" name="smoking"  value="1" <?php if($row[AllowSmoking] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="smoking"  value="0" <?php if($row[AllowSmoking] == '0'){echo "checked='checked'";}?>/>
                    </td> 
                </tr>
                <tr>
                    <td>
                        Will you allow an applicant with a slightly different move-in date availability to submit a PFO?<br/>
                        Yes<input type="radio" name="moveInDate"  value="1" <?php if($row[PreMarket] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="moveInDate"  value="0" <?php if($row[PreMarket] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
                        Would you like to limit the number of occupants in your property?<br/>
                        Yes<input type="radio" name="numberOfOccupants"  value="1" <?php if($row[PreMarket] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="numberOfOccupants"  value="0" <?php if($row[PreMarket] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Will you allow cats?<br/>
                        Yes<input type="radio" name="cats"  value="1" <?php if($row[AllowCats] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="cats"  value="0" <?php if($row[AllowCats] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
                        Will you allow dogs?<br/>
                        Yes<input type="radio" name="dogs"  value="1" <?php if($row[AllowDogs] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="dogs"  value="0" <?php if($row[AllowDogs] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
                        Required Pet Deposit<br/>
                        Yes<input type="radio" name="petdeposit"  value="1" <?php if($row[PetDepost] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="petdeposit"  value="0" <?php if($row[PetDepost] == '0'){echo "checked='checked'";}?>/>
                    </td>
                </tr>
                <tr>
                    <td>
                        
                        Is Pet Deposit Refundable?<br/>
                        Yes<input type="radio" name="petDepositrefundable"  value="1" <?php if($row[AllowPetDepositRefund] == '1'){echo "checked='checked'";}?>/>
                        No<input type="radio" name="petDepositRefundable"  value="0" <?php if($row[AllowPetDepositRefund] == '0'){echo "checked='checked'";}?>/>
                    </td>
                    <td>
