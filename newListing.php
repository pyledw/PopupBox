...
<!-- Page Content -->
    ...
    <div id="mainContent">
        ...
        <?php
                ...
                createDropdownMenu("drop1","numberOfBedrooms", array("1","2","3","4","5"), "Number Of Bedrooms: ");
                createDropdownMenu("drop2","numberOfBathrooms", array("1","2","3","4","5"),"Number Of Bathrooms: ");
                createDropdownMenu("drop3","garage", array("Garage","Carport","Other","None"), "Garage: ");
                createDropdownMenu("drop4","heating", array("Electric heating","Gas heating","Wood burning Stove","Dual","None"), "Type of Heating");
                newLine();
                createDropdownMenu("drop5","airConditioning", array("Electric air","None"), "Air Conditioning: ");
                createDropdownMenu("drop6","TV", array("Cable","Satilite","None"), "Media: ");
